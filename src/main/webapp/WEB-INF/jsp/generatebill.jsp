...
<div class="box box-primary">
                ...
                <!-- form start -->
                <form action="/HealthCare/billGeneration" method="post" role="form">
                  <div class="box-body">
 <!--                   <div class="form-group">
                    ...
                    <!-- <div class="form-group">
                      ...
                      <input type="text"  maxlength="10" name="mobileNumber" class="form-control" id="mobileNumber" placeholder="Enter Mobile Number">
                    </div>
                    <!-- <div class="form-group">
